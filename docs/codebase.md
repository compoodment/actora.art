...
The tracked public surface is documentation and release notes only.

## What stays public

- visitor-facing behavior notes
- identity and hosting boundary notes
- privacy notes
...
- admin, moderation, security, and account-control internals
