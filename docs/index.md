...
6. [hosting](deploy.md) — what the static frontend expects around it
7. [testing](testing.md) — manual checks

These docs cover the public site and frontend code. Live operations live elsewhere.
