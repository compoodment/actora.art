...
- social friend requests, friendships, private directional message mutes and blocks, System notices, and friends-only DMs for signed-in social features
