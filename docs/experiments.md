...
It includes generated family setup, later sibling births, meeting NPCs, lifecycle identity choices, local event history, action records, month-by-month advancement, pending choices, in-game relationship links from meeting choices, Hang out actions, and Life/Actions/Profile/Relationships/History sections. Life puts the live story first and keeps its overview plus compact Advance/Skip controls alongside it. Actions groups Social and Personal choices beside the queue and time budget. Relationships is the sole family/social index and uses one searchable people-and-detail browser, while Profile keeps six factual sections and leaves chronology to History; Mood + Needs and Skills / Talents remain honest placeholders. The live feed remains immediate story context rather than replacing the complete History. First-pass death continuation moves through a finished-life summary, available linked lives, candidate detail, and explicit confirmation.
