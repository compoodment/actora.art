...
It simulates Newtonian gravity between bodies, includes a few presets, and exposes trails, future-path controls, a collapsible body list, body-focused Focus/Follow camera actions, selected-body halos, less-inflated body markers, and compact diagnostics so the simulation can be inspected while it evolves.
