...
It is a separate game-mode surface rather than a generic site experiment panel. The current public version is a visual scaffold: title/start/save-lite controls, current actor HUD, time controls, action cards, queue, event feed, world context, and Profile/Relationships/History navigation cards. It is not connected to account saves or the full Actora simulation yet.
