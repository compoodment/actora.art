...
It simulates Newtonian gravity between bodies, includes a few presets, and exposes trails, prediction controls, selected-body halos, and diagnostics so the simulation can be inspected while it evolves.
